...
class Gsender
{
    ...
    private:
        ...
        const char* emailBase64Login = "";
        const char* emailBase64Password = "";
        const char* from = "";
        const char* to = "";
    ...
    public:
        ...
        void setup(const char *smtpServer, const char * login, const char * password, const char * from,const char * to, int port);

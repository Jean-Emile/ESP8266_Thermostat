...
void setup(void)
{
    ...
    Serial.printf("[INFO] \n\nSdk version: %s\n", ESP.getSdkVersion());
    Serial.printf("[INFO] Core Version: %s\n", ESP.getCoreVersion().c_str());
    Serial.printf("[INFO] Boot Version: %u\n", ESP.getBootVersion());
    Serial.printf("[INFO] Boot Mode: %u\n", ESP.getBootMode());
    Serial.printf("[INFO] CPU Frequency: %u MHz\n", ESP.getCpuFreqMHz());
    Serial.printf("[INFO] Reset reason: %s\n", ESP.getResetReason().c_str());
}
int ping_counter = 0;
void loop(void)
{
